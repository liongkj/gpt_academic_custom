...
def 解析PDF(
    ...
    for file_name in file_manifest:
        ...
        for i in range(n_fragment):
            ...
            i_say = f"Read this section, recapitulate the content of this section with less than {NUM_OF_WORD} english characters: {paper_fragments[i]}"
            i_say_show_user = f"[{i+1}/{n_fragment}] Read this section, recapitulate the content of this section with less than {NUM_OF_WORD} english characters: {paper_fragments[i][:200]}"
            gpt_say = yield from request_gpt_model_in_new_thread_with_ui_alive(
                ...
                sys_prompt="Extract the main idea of this section in English.",  # 提示
            )
...
2. summarize according to the following four points.Be sure to use English answers
    - (1):What is the research background of this article?
    - (2):What are the past methods? What are the problems with them? Is the approach well motivated?
    - (3):What is the research methodology proposed in this paper?
    - (4):What is the significance of this paper?
...
2. Summary: \n\n
    ...
    - (3):xxx;\n
    - (4):xxx.\n\n
Be sure to use English answers, statements as concise and academic as possible,
do not have too much repetitive information, numerical values using the original numbers.
        ...
        i_say, final_results = input_clipping(
            i_say, final_results, max_token_limit=2000
        )
        gpt_say = yield from request_gpt_model_in_new_thread_with_ui_alive(
            inputs=i_say,
            ...
            sys_prompt=f"Extract the main idea of this paper with less than {NUM_OF_WORD} english characters",
        )
